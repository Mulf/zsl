...
vector_d zsl::vadd(double a, const vector_d &v) { return v + a; }
...
vector_d zsl::vmul(double a, const vector_d &v) { return v * a; }
...
vector_d operator+(const vector_d &v, double a) { return zsl::vadd(v, a); }

vector_d operator+(double a, const vector_d &v) { return zsl::vadd(a, v); }

vector_d operator-(const vector_d &v1, const vector_d &v2) {
  return zsl::vsub(v1, v2);
}

vector_d operator-(const vector_d &v, double a) { return zsl::vsub(v, a); }

vector_d operator-(double a, const vector_d &v) { return zsl::vsub(a, v); }

vector_d operator*(const vector_d &v1, const vector_d &v2) {
  return zsl::vmul(v1, v2);
}

vector_d operator*(const vector_d &v, double a) { return zsl::vmul(v, a); }

vector_d operator*(double a, const vector_d &v) { return zsl::vmul(a, v); }

vector_d operator/(const vector_d &v1, const vector_d &v2) {
  return zsl::vdiv(v1, v2);
}

vector_d operator/(const vector_d &v, double a) { return zsl::vdiv(v, a); }

vector_d operator/(double a, const vector_d &v) { return zsl::vdiv(a, v); }

void operator+=(vector_d &v, const vector_d &w) { zsl::vadd_self(v, w); }

void operator+=(vector_d &v, double a) { zsl::vadd_self(v, a); }

void operator-=(vector_d &v, const vector_d &w) { zsl::vsub_self(v, w); }

void operator-=(vector_d &v, double a) { zsl::vsub_self(v, a); }

void operator*=(vector_d &v, const vector_d &w) { zsl::vmul_self(v, w); }

void operator*=(vector_d &v, double a) { zsl::vmul_self(v, a); }

void operator/=(vector_d &v, const vector_d &w) { zsl::vdiv_self(v, w); }

void operator/=(vector_d &v, double a) { zsl::vdiv_self(v, a); }
...
void operator+=(zsl::matrix_d &m, double d) { zsl::madd_self(m, d); }
